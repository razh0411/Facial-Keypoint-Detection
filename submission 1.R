...
d.train <- d.train[sample(nrow(d.train),1000),]
...
example.submission <- read.csv("Desktop/MA 676/Data Competition/IdLookupTable.csv")
...
write.table(submission, "Desktop/nose1.csv", sep="\t")



########### First example: when search_size = 3 ###############
search_size <- 3
...
write.csv(submission, file="submission_search.csv", quote=F, row.names=F)
write.table(submission, "Desktop/nose3.csv", sep="\t")



######## submission file 

sub1 <- read.csv("Desktop/MA 676/Data Competition/submission file/nose1.csv")
sub1 <- sub1[-(3567:27124),]
write.table(sub1, "Desktop/nose1.csv", sep="\t")

sub3 <- read.csv("Desktop/MA 676/Data Competition/submission file/nose3.csv",sep="\t")
sub3 <- sub3[-(3567:27124),]
write.table(sub3, "Desktop/nose3.csv", sep="\t")
